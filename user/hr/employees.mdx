---
title: "Odoo HR: Manage Employees, Contracts, and Time Off"
sidebarTitle: "Employees"
description: "Centralize employee records, manage job positions and contracts, track time off and attendance, and visualize your organization chart in Odoo HR."
---
...
<CardGroup cols={2}>
  <Card title="Schedule Appraisals" icon="calendar">
  ...
  <Card title="Employee Self-Assessment" icon="pen-line">
  ...
  <Card title="Manager Feedback and 360 Reviews" icon="users">
  ...
  <Card title="Goals and Skills" icon="target">
