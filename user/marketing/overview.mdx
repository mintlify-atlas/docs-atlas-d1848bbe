---
title: "Odoo Marketing: Email, SMS, Events, and Social Media"
sidebarTitle: "Marketing"
description: "Run targeted email and SMS campaigns, automate multi-channel workflows, manage events with ticketing, and publish social media posts from Odoo Marketing."
---
...
<CardGroup cols={2}>
  <Card title="Create Surveys" icon="clipboard-list">
  ...
  <Card title="Live Sessions" icon="presentation">
  ...
  <Card title="Survey Analysis" icon="chart-bar">
  ...
  <Card title="Scoring and Certifications" icon="award">
...
<CardGroup cols={2}>
  <Card title="Card Campaigns" icon="layout-template">
  ...
  <Card title="Card Design" icon="paint-brush">
  ...
  <Card title="Bulk Email Distribution" icon="mail">
