...
description: "Odoo's Git workflow: branch naming, the four-part commit message format, all valid commit tags, squash and merge rules, and the PR review process."
---
