...
description: "Odoo coding standards for Python (PEP8 + Odoo idioms), module structure, XML/QWeb formatting, class attribute ordering, method conventions, and JavaScript/SCSS rules."
---
...
class Event(models.Model):
    ...
    # 4. Compute, inverse, and search methods (same order as field declarations)
    ...
    # 7. CRUD overrides (create, write, unlink, name_search, …)
    @api.model
...
- Always include `'use strict';` at the top of JavaScript files.
- Use a linter (`jshint` or ESLint with the Odoo config).
