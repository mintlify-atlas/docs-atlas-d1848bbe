---
title: 'Build and Customize Odoo Website Themes'
sidebarTitle: 'Website Themes'
description: 'Create an Odoo website theme module: inherit from the default theme, override SCSS variables, define color palettes, custom fonts, and build snippet blocks.'
---
