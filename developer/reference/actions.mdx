...
description: 'Reference for Odoo action types: ir.actions.act_window for views, ir.actions.server for server code, ir.actions.report for PDFs, and ir.actions.act_url.'
---
